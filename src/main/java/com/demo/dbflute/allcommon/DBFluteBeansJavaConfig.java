...
import com.demo.dbflute.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="com.demo.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.demo.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.demo.dbflute.allcommon.ImplementedInvokerAssistant();
    }
